<?php $__env->startSection('title', 'Flexible Packaging Inks Industry Overview'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-32 pb-24 bg-slate-900 text-white overflow-hidden">
        ...
        <div class="absolute inset-0 opacity-25"
            style="background-image: url('<?php echo e(asset('images/sectors/packaging-inks-hero.png')); ?>'); background-size: cover; background-position: center;">
        </div>
        ...
        <div class="container space-y-16">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative group animate-in fade-in slide-in-from-right duration-700">
                    ...
                    <img src="<?php echo e(asset('images/sectors/packaging-inks-details.png')); ?>" alt="Packaging Inks Industry"
                ...
                <div class="relative z-10 grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <?php $__currentLoopData = ['USA', 'Germany', 'China', 'India', 'Japan', 'Italy']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="p-8 bg-pink-600 rounded-2xl shadow-xl">
                        ...
                        <div class="grid grid-cols-2 gap-3 text-xs font-black uppercase">
                            <?php $__currentLoopData = ['Mumbai', 'Ahmedabad', 'Delhi NCR', 'Hyderabad', 'Chennai', 'Pune']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center gap-2">
                                    <i class="fa-solid fa-circle-dot text-[8px]"></i> <?php echo e($hub); ?>
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\msmeccii\resources\views/website/sectors/flexible-packaging-inks.blade.php ENDPATH**/ ?>