<?php $__env->startSection('title', 'Information Technology Industry Overview'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-32 pb-24 bg-slate-900 text-white overflow-hidden">
        ...
        <div class="absolute inset-0 opacity-25"
            style="background-image: url('<?php echo e(asset('images/sectors/it-hero.png')); ?>'); background-size: cover; background-position: center;">
        </div>
        ...
        <div class="container space-y-16">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative group animate-in fade-in slide-in-from-right duration-700">
                    ...
                    <img src="<?php echo e(asset('images/sectors/it-details.png')); ?>" alt="IT Industry"
                ...
                <div class="p-8 rounded-3xl bg-gradient-to-br from-slate-800 to-slate-900 text-white shadow-2xl transform hover:-translate-y-1 transition-transform duration-300">
                    ...
                    <div class="mt-8">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php $__currentLoopData = ['AI Adoption', 'Cloud Migration', 'Cybersecurity', 'Data Analytics']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="p-10 rounded-3xl bg-slate-900 text-white overflow-hidden relative">
                ...
                <div class="relative z-10 grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="p-8 bg-indigo-600 rounded-2xl shadow-xl">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php $__currentLoopData = ['Bengaluru', 'Hyderabad', 'Pune', 'Chennai', 'Mumbai', 'Delhi NCR']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="px-3 py-1 bg-white/20 rounded-full text-xs font-bold border border-white/10"><?php echo e($hub); ?></span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="order-2 md:order-1 space-y-8">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="flex items-center gap-3 p-4 rounded-xl bg-slate-50 border border-slate-100 hover:border-indigo-200 hover:bg-white transition-all group">
                            ...
                            <span class="font-bold text-slate-700 text-sm leading-tight uppercase font-serif italic"><?php echo e($i['title']); ?></span>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                ...
                <div class="order-1 md:order-2 p-8 bg-slate-100 rounded-3xl border border-slate-200 shadow-sm relative overflow-hidden group">
                    <div class="relative z-10">
                        ...
                        <div class="flex flex-wrap gap-3">
                            <?php $__currentLoopData = ['USA', 'India', 'China', 'Germany', 'UK', 'Japan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center gap-2 px-4 py-2 bg-white rounded-full border border-slate-200 text-sm font-bold text-slate-600 group-hover:border-indigo-300 transition-colors">
                                <i class="fa-solid fa-globe text-indigo-500"></i> <?php echo e($country); ?>
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\msmeccii\resources\views/website/sectors/it-industry.blade.php ENDPATH**/ ?>