<?php $__env->startSection('title', 'Market Intelligence & Data Analytics - MSMECCII'); ?>
        ...
        <div class="container space-y-32">
            ...
            <div class="space-y-12">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $port): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group relative overflow-hidden rounded-[2.5rem] bg-slate-900 h-[400px] shadow-lg">
                        <img src="<?php echo e($port['img']); ?>" class="w-full h-full object-cover group-hover:scale-110 grayscale group-hover:grayscale-0 transition-all duration-1000 opacity-60 group-hover:opacity-100" alt="Intelligence Step">
                        <div class="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-900/20 to-transparent"></div>
                        <div class="absolute bottom-10 left-10 right-10">
                            <h4 class="text-2xl font-black text-amber-500 mb-4 uppercase italic tracking-tight"><?php echo e($port['t']); ?></h4>
                            <p class="text-white/80 text-[10px] font-bold leading-relaxed uppercase tracking-widest"><?php echo e($port['d']); ?></p>
                        </div>
                    </div>
            ...
            <div class="bg-amber-100 p-16 rounded-[4rem] relative overflow-hidden text-center space-y-12 shadow-inner border border-amber-200">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div class="p-8 bg-white/80 backdrop-blur rounded-3xl shadow-sm hover:-translate-y-2 transition-transform border border-white">
                        <i class="fa-solid fa-<?php echo e($tech['icon']); ?> text-3xl mb-4 text-amber-600"></i>
                        <p class="text-xs font-black uppercase text-slate-800 tracking-tighter"><?php echo e($tech['title']); ?></p>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <div class="relative bg-slate-950 text-white p-20 rounded-[5rem] text-center shadow-4xl overflow-hidden border-b-[20px] border-amber-600 group">
                ...
                <div class="relative z-10 space-y-12 text-center">
                    ...
                    <a href="<?php echo e(route('forms.show', ['slug' => 'join-us'])); ?>" class="inline-flex items-center gap-6 px-16 py-8 bg-white text-slate-900 font-black uppercase tracking-[0.2em] rounded-full hover:bg-amber-600 hover:text-white transition-all duration-700 shadow-4xl transform hover:scale-110">
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\msmeccii\resources\views/website/services/market-intelligence.blade.php ENDPATH**/ ?>