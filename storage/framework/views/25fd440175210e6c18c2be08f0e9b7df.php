<?php $__env->startSection('title', 'Food & Beverages Industry Overview'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-32 pb-24 bg-slate-900 text-white overflow-hidden">
        ...
        <div class="absolute inset-0 opacity-30"
            style="background-image: url('<?php echo e(asset('images/sectors/rice.png')); ?>'); background-size: cover; background-position: center;">
        </div>
        ...
        <div class="container space-y-16">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative group animate-in fade-in slide-in-from-right duration-700">
                    ...
                    <img src="<?php echo e(asset('images/sectors/rice.png')); ?>" alt="Food & Beverages Industry"
            ...
            <div class="grid md:grid-cols-2 gap-10">
                ...
                <div class="p-8 rounded-3xl bg-slate-50 border border-slate-200 shadow-xl transform hover:-translate-y-1 transition-transform duration-300">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <?php $__currentLoopData = ['Mumbai', 'Delhi NCR', 'Bengaluru', 'Hyderabad', 'Pune', 'Ahmedabad']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="px-3 py-1 bg-white border border-slate-200 text-slate-600 text-xs font-bold rounded-full"><?php echo e($city); ?></span>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="order-2 md:order-1 relative">
                    <img src="<?php echo e(asset('images/sectors/manufacturing.jpg')); ?>" alt="Food Industry Opportunities"
                ...
                <div class="order-1 md:order-2">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-100 hover:bg-white hover:border-orange-200 hover:shadow-lg transition-all group">
                            ...
                            <span class="font-bold text-slate-700"><?php echo e($item['title']); ?></span>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            ...
            <div class="bg-slate-900 p-12 rounded-3xl relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                        <?php $__currentLoopData = ['Dairy', 'Spices', 'Rice & Grains', 'Processed Foods', 'Packaged Snacks']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-4 bg-white/5 border border-white/10 rounded-2xl text-center">
                            <p class="text-white font-bold text-sm"><?php echo e($item); ?></p>
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\msmeccii\resources\views/website/sectors/food-beverages-industry.blade.php ENDPATH**/ ?>