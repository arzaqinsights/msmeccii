...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-32 pb-24 bg-slate-900 text-white overflow-hidden">
        ...
        <div class="absolute inset-0 opacity-20"
            style="background-image: url('<?php echo e(asset('images/sectors/waste-management.jpg')); ?>'); background-size: cover; background-position: center;">
        </div>
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <?php $__currentLoopData = ['Plastic Packaging', 'E-Waste', 'Battery Waste', 'Waste Tyres', 'Used Oil', 'Hazardous Waste']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stream): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center gap-2 text-xs font-bold text-slate-600 p-2 bg-white rounded-lg border border-slate-100">
                                <i class="fa-solid fa-recycle text-blue-500"></i> <?php echo e($stream); ?>
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\msmeccii\resources\views/website/sectors/epr-industry.blade.php ENDPATH**/ ?>