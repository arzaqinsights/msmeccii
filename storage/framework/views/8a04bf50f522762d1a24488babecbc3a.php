...
<section class="relative min-h-[60vh] flex items-center pt-32 pb-24 overflow-hidden bg-slate-900">
    <div class="absolute inset-0 z-0">
        <img src="<?php echo e($event->image ? asset($event->image) : asset('images/event-placeholder.jpg')); ?>" alt="<?php echo e($event->title); ?>" class="w-full h-full object-cover opacity-30 scale-105 blur-sm">
            ...
            <aside class="w-full hidden lg:block lg:w-1/4 sticky top-32 z-30">
                <div class="bg-white rounded-2xl shadow-2xl border border-slate-100 overflow-hidden transform transition-all hover:scale-[1.02]">
                    ...
                    <div class="p-2">
                        <nav class="space-y-1">
                            ...
                            <?php $__currentLoopData = $navItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(isset($event->builder_content[$item['id']]) && (!is_array($event->builder_content[$item['id']]) || count($event->builder_content[$item['id']]) > 0)): ?>
                                    <a href="#<?php echo e($item['id']); ?>" 
                                       @click="activeSection = '<?php echo e($item['id']); ?>'"
                                       :class="activeSection === '<?php echo e($item['id']); ?>' ? 'bg-brand-primary text-white shadow-xl shadow-brand-primary/20' : 'text-slate-600 hover:bg-slate-50'"
                    ...
                    <div class="p-6 bg-slate-50 border-t border-slate-100">
                        <a href="<?php echo e($event->builder_content['about']['registration_url'] ?? url('application/delegate-registration')); ?>" target="_blank" class="block w-full bg-slate-900 hover:bg-black text-white text-center py-4 rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl transition-all">
                ...
                <div class="mt-6 bg-linear-to-br from-brand-primary to-brand-primary-light rounded-2xl p-6 text-white shadow-xl shadow-brand-primary/20">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center gap-3 text-xs font-bold">
                            ...
                            <a href="mailto:<?php echo e($event->builder_content['about']['email'] ?? 'events@msmeccii.in'); ?>" class="hover:underline">events@msmeccii.in</a>
                        </div>
                        <div class="flex items-center gap-3 text-xs font-bold">
                                        ...
                                        <div class="group bg-white rounded-2xl p-6 border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-1">
                                            <div class="aspect-video bg-slate-50 rounded-2xl mb-5 overflow-hidden border border-slate-100 relative">
                                                ...
                                                <div class="absolute inset-0 bg-slate-900/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-[2px]">
                                                    <a href="<?php echo e(asset($hl['pdf1_path'])); ?>" target="_blank" class="bg-white text-slate-900 px-6 py-2.5 rounded-full text-xs font-black uppercase tracking-widest shadow-2xl transform translate-y-4 group-hover:translate-y-0 transition-all duration-500 hover:bg-brand-primary hover:text-white">
                                            ...
                                            <div class="flex items-center justify-between">
                                                <div>
                                                    ...
                                                    <h5 class="text-sm font-black text-slate-900 uppercase"><?php echo e($hl['pdf1_name'] ?: 'Strategic Document'); ?></h5>
                                                </div>
                                                <a href="<?php echo e(asset($hl['pdf1_path'])); ?>" target="_blank" class="w-10 h-10 rounded-full bg-brand-primary/10 text-brand-primary flex items-center justify-center hover:bg-brand-primary hover:text-white transition-all">
                                    ...
                                    <?php if(isset($hl['pdf2_path']) && $hl['pdf2_path']): ?>
                                        <div class="group bg-white rounded-2xl p-6 border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-1">
                                            <div class="aspect-video bg-slate-50 rounded-2xl mb-5 overflow-hidden border border-slate-100 relative">
                                                ...
                                                <?php endif; ?>
                                                <div class="absolute inset-0 bg-slate-900/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-[2px]">
                                                    <a href="<?php echo e(asset($hl['pdf2_path'])); ?>" target="_blank" class="bg-white text-slate-900 px-6 py-2.5 rounded-full text-xs font-black uppercase tracking-widest shadow-2xl transform translate-y-4 group-hover:translate-y-0 transition-all duration-500 hover:bg-brand-primary hover:text-white">
                                                        View Document <i class="fa-solid fa-up-right-from-square ml-2 text-[10px]"></i>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="flex items-center justify-between">
                                                <div>
                                                    ...
                                                    <h5 class="text-sm font-black text-slate-900 uppercase"><?php echo e($hl['pdf2_name'] ?: 'Resource Guide'); ?></h5>
                                                </div>
                                                <a href="<?php echo e(asset($hl['pdf2_path'])); ?>" target="_blank" class="w-10 h-10 rounded-full bg-brand-primary/10 text-brand-primary flex items-center justify-center hover:bg-brand-primary hover:text-white transition-all">
                                                    <i class="fa-solid fa-up-right-from-square text-xs"></i>
                                                </a>
                                            </div>
                                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                        <?php $__currentLoopData = $event->builder_content['pricing']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-white/5 backdrop-blur-md border border-white/10 rounded-[2.5rem] p-10 hover:border-brand-accent transition-all group">
                                <h4 class="text-xs font-black text-slate-400 uppercase tracking-widest mb-2"><?php echo e($tier['type']); ?></h4>
                                <div class="flex items-end gap-2 mb-6">
                                    <span class="text-sm font-bold text-brand-accent opacity-60 mb-2"><?php echo e($tier['currency'] ?? 'INR'); ?></span>
                                    <span class="text-5xl font-black text-white tracking-tighter"><?php echo e($tier['price']); ?></span>
                                ...
                                <a href="<?php echo e($event->builder_content['about']['registration_url'] ?? 'https://rzp.io/l/msmeccii'); ?>" target="_blank" class="block w-full bg-brand-accent hover:bg-white text-slate-900 text-center py-4 rounded-2xl font-black text-xs uppercase tracking-widest transition-all">
                    ...
                    <div class="space-y-4 max-w-3xl mx-auto" x-data="{ openFaq: null }">
                        <?php $__currentLoopData = $event->builder_content['faq']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-white rounded-3xl border border-slate-100 overflow-hidden shadow-sm">
                                <button @click="openFaq = openFaq === <?php echo e($index); ?> ? null : <?php echo e($index); ?>" class="w-full flex items-center justify-between p-6 text-left">
                                ...
                                <div x-show="openFaq === <?php echo e($index); ?>" x-collapse class="px-6 pb-6">
                ...
                <div id="resources" class="scroll-mt-36 animate-on-scroll">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                        <?php $__currentLoopData = $event->builder_content['resources']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $res): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(asset($res['url'])); ?>" target="_blank" class="group bg-white rounded-2xl border border-slate-200 overflow-hidden hover:border-brand-primary hover:shadow-2xl transition-all duration-300 flex flex-col">
                                <!-- Image Part -->
                        ...
                        <div class="flex gap-8 items-center animate-logo-slide whitespace-nowrap">
                            ...
                            <?php $__currentLoopData = $slidingPartners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex-none bg-white rounded-3xl p-8 border border-slate-50 shadow-xs flex flex-col items-center justify-center h-auto min-h-40 w-64 group transition-all">
                                    <img src="<?php echo e(asset($partner['logo'])); ?>" alt="<?php echo e($partner['name']); ?>" class="max-h-24 max-w-full object-contain transition-all duration-500">
                                    <?php if(isset($partner['name']) && $partner['name']): ?>
                                        <p class="mt-4 text-[10px] font-black text-slate-900 uppercase tracking-[0.2em] text-center group-hover:text-brand-primary transition-colors"><?php echo e($partner['name']); ?></p>
                                    <?php endif; ?>
                                    <?php if(isset($partner['is_pending']) && $partner['is_pending']): ?>
