<?php $__env->startSection('title', 'Elite Networking & B2B Matchmaking - MSMECCII'); ?>
        ...
        <div class="container space-y-32">
            ...
            <div class="space-y-12">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eco): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group relative h-[450px] overflow-hidden rounded-[3rem] shadow-lg border-b-[8px] border-indigo-600">
                        <img src="<?php echo e($eco['img']); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" alt="Networking Step">
                        <div class="absolute inset-0 bg-gradient-to-t from-indigo-950 via-slate-900/10 to-transparent"></div>
                        <div class="absolute bottom-10 left-10 right-10">
                            <h4 class="text-2xl font-black text-white mb-4 uppercase italic tracking-tight"><?php echo e($eco['t']); ?></h4>
                            <p class="text-indigo-200 text-xs font-bold leading-relaxed opacity-80 group-hover:opacity-100 transition-opacity"><?php echo e($eco['d']); ?></p>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="grid md:grid-cols-2 gap-8">
                            ...
                            <div class="flex items-center gap-4 group">
                                ...
                                <span class="text-xs font-black uppercase tracking-tight"><?php echo e($item); ?></span>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
            ...
            <div class="relative bg-slate-950 text-white p-20 rounded-[5rem] text-center shadow-4xl overflow-hidden border-b-[20px] border-indigo-600 group">
                ...
                <div class="relative z-10 space-y-12">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center gap-6 px-16 py-8 bg-white text-indigo-900 font-black uppercase tracking-[0.2em] rounded-full hover:bg-indigo-600 hover:text-white transition-all duration-700 shadow-4xl transform hover:scale-110">
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\msmeccii\resources\views/website/services/elite-networking.blade.php ENDPATH**/ ?>