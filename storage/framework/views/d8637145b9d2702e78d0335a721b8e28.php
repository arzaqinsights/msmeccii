<?php $__env->startSection('title', 'ESG Industry Overview'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-32 pb-24 bg-slate-900 text-white overflow-hidden">
        ...
        <div class="absolute inset-0 opacity-20"
            style="background-image: url('<?php echo e(asset('images/sectors/esg-industry.jpg')); ?>'); background-size: cover; background-position: center;">
        </div>
        ...
        <div class="container space-y-16">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative group animate-in fade-in slide-in-from-right duration-700">
                    ...
                    <img src="<?php echo e(asset('images/sectors/esg-industry.jpg')); ?>" alt="ESG Industry"
            ...
            <div class="grid md:grid-cols-2 gap-10">
                ...
                <div class="p-8 rounded-3xl bg-slate-50 border border-slate-200 shadow-xl transform hover:-translate-y-1 transition-transform duration-300">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <?php $__currentLoopData = ['Manufacturing', 'Energy', 'FMCG', 'Banking & Finance', 'IT', 'Infrastructure']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="px-3 py-1 bg-slate-200 text-slate-700 text-xs font-bold rounded-full"><?php echo e($tag); ?></span>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="order-2 md:order-1 relative">
                    <img src="<?php echo e(asset('images/sectors/esg-details.jpg')); ?>" alt="ESG Opportunities"
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\msmeccii\resources\views/website/sectors/esg-industry.blade.php ENDPATH**/ ?>