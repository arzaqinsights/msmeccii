<?php $__env->startSection('title', 'Leather Industry Overview'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-32 pb-24 bg-slate-900 text-white overflow-hidden">
        ...
        <div class="absolute inset-0 opacity-25"
            style="background-image: url('<?php echo e(asset('images/sectors/leather.webp')); ?>'); background-size: cover; background-position: center;">
        </div>
        ...
        <div class="container space-y-16">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative group animate-in fade-in slide-in-from-right duration-700">
                    ...
                    <img src="<?php echo e(asset('images/sectors/leather.webp')); ?>" alt="Leather Industry"
            ...
            <div class="grid md:grid-cols-2 gap-10">
                ...
                <div class="p-8 rounded-3xl bg-slate-50 border border-slate-200 shadow-xl transform hover:-translate-y-1 transition-transform duration-300">
                    ...
                    <div class="grid grid-cols-3 gap-2 mb-6">
                        <?php $__currentLoopData = ['Kanpur', 'Agra', 'Chennai', 'Kolkata', 'Delhi', 'Mumbai']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="px-2 py-1 bg-white border border-slate-200 text-[10px] font-bold text-slate-500 rounded text-center"><?php echo e($hub); ?></div>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="order-2 md:order-1 relative">
                    <img src="<?php echo e(asset('images/sectors/leather-details.jpg')); ?>" alt="Leather Details"
                ...
                <div class="relative z-10 grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-x-6 gap-y-3">
                            <?php $__currentLoopData = ['Leather Footwear', 'Saddlery & Harness', 'Finished Leather', 'Leather Garments']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center gap-3 text-xs font-bold text-amber-500/80">
                                    <i class="fa-solid fa-check text-[8px]"></i> <?php echo e($cat); ?>
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\msmeccii\resources\views/website/sectors/leather-industry.blade.php ENDPATH**/ ?>