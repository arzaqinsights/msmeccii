                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div
                            ...
                            <div
                                ...
                                <?php echo e($upcomingEvents->count()); ?>+</div>
                    ...
                    <?php $__currentLoopData = $upcomingEvents->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="group bg-white rounded-lg overflow-hidden border shadow-sm hover:shadow-2xl hover:shadow-slate-200 transition-all duration-500 animate-on-scroll flex flex-col h-full"
                            ...
                            <div class="relative h-64 overflow-hidden shrink-0">
                                ...
                                <div class="absolute top-4 right-4 z-20">
                                    <span
                                        ...
                                        <?php echo e($event->design_style === 'featured' ? '★ Featured' : 'Summit'); ?>
                            ...
                            <div class="p-6 flex flex-col grow">
                                <a href="<?php echo e(route('events.show', $event->slug)); ?>" class="block mb-4 grow">
                                    <h3
