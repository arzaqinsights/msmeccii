<?php $__env->startSection('title', 'Create Manual Invoice'); ?>
...
<div class="max-w-4xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="<?php echo e(route('admin.submissions.index')); ?>" class="text-slate-500 hover:text-slate-800 font-bold text-sm bg-white border border-slate-200 px-4 py-2 rounded-xl transition-all">
            <i class="fa-solid fa-arrow-left mr-1"></i> Back to Submissions
        </a>
    </div>

    <form action="<?php echo e(route('admin.submissions.manual-store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-8" 
          x-data="{ 
            userMode: 'existing', 
            selectedUser: '', 
            details: {
                ...
                <div class="mb-8 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                    ...
                    <select name="invoice_template_id" class="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm font-bold text-slate-700 outline-none focus:border-brand-primary">
                        ...
                        <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tpl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($tpl->id); ?>" <?php echo e($tpl->is_default ? 'selected' : ''); ?>><?php echo e($tpl->name); ?></option>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\msmeccii\resources\views/admin/submissions/manual_create.blade.php ENDPATH**/ ?>