<?php $__env->startSection('title', 'Legal & Government Liaisoning Services - MSMECCII'); ?>
        ...
        <div class="container space-y-32">
                ...
                <div class="space-y-8 animate-on-scroll order-1 lg:order-2">
                    ...
                    <p class="text-slate-600 text-lg leading-relaxed">
                     ...
                     <div class="grid grid-cols-2 gap-4">
                        <?php $__currentLoopData = ['Environmental', 'Corporate Law', 'Arbitration', 'Licensing']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $law): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="space-y-12">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div class="group relative h-[450px] overflow-hidden rounded-[3rem] shadow-xl border-t-[8px] border-emerald-600">
                        <img src="<?php echo e($li['img']); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-1000 grayscale group-hover:grayscale-0" alt="Liaisoning Area">
                        <div class="absolute inset-0 bg-gradient-to-t from-emerald-950 via-slate-900/10 to-transparent"></div>
                        <div class="absolute bottom-10 left-10 right-10">
                            <h4 class="text-2xl font-black text-white mb-4 uppercase italic tracking-tight"><?php echo e($li['t']); ?></h4>
                            <p class="text-emerald-100 text-[10px] font-bold leading-relaxed uppercase opacity-80 group-hover:opacity-100 transition-opacity"><?php echo e($li['d']); ?></p>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <div class="p-20 rounded-[4rem] bg-slate-950 text-white relative overflow-hidden shadow-3xl flex flex-col items-center space-y-12 overflow-hidden">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-12 w-full">
                    ...
                    <div class="text-center p-8 bg-white/5 border border-white/10 rounded-3xl backdrop-blur-md">
                        <p class="text-emerald-500 font-black text-2xl mb-2"><?php echo e($metric['val']); ?></p>
                        <p class="text-[10px] font-black uppercase text-slate-400 tracking-widest"><?php echo e($metric['t']); ?></p>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            ...
            <div class="relative bg-slate-950 text-white p-24 rounded-[5rem] text-center shadow-4xl overflow-hidden border-b-[24px] border-emerald-600 group">
                ...
                <div class="relative z-10 space-y-12 text-center">
                    ...
                    <a href="<?php echo e(route('forms.show', ['slug' => 'join-us'])); ?>" class="inline-flex items-center gap-6 px-16 py-8 bg-white text-slate-900 font-black uppercase tracking-[0.2em] rounded-full hover:bg-emerald-600 hover:text-white transition-all duration-700 shadow-4xl transform hover:scale-110">
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\msmeccii\resources\views/website/services/legal-liasoning.blade.php ENDPATH**/ ?>