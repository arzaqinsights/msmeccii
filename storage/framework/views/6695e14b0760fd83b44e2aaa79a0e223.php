...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('website.about.partials.impact_stats', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <section class="py-24 bg-brand-primary-dark relative overflow-hidden">
        ...
        <div class="container relative z-10 text-center animate-on-scroll">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-6">
                <a href="<?php echo e(route('about.chairman')); ?>" class="group relative px-12 py-5 bg-brand-accent text-brand-primary rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl shadow-brand-accent/20 hover:scale-105 transition-all overflow-hidden">
                ...
                <a href="<?php echo e(route('about.leadership')); ?>" class="px-12 py-5 bg-white/5 border-2 border-white/20 text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-white hover:text-brand-primary hover:border-white transition-all">
