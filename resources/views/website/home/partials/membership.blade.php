        ...
        <div class="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div class="w-full lg:w-1/2 animate-on-scroll">
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-4">
                        <div class="bg-brand-primary/10 border backdrop-blur rounded-2xl p-6 hover:bg-brand-primary/30 transition-all border-brand-primary" style="border-width: 2px;">
                            <i class="fa-solid fa-id-card text-brand-accent text-2xl mb-4 block"></i>
                            <h4 class="text-brand-primary font-bold mb-2">Member ID & Certificate</h4>
                        ...
                        <div class="bg-brand-primary/10 border backdrop-blur rounded-2xl p-6 hover:bg-brand-primary/30 transition-all border-brand-primary" style="border-width: 2px;">
                            ...
                            <h4 class="text-brand-primary font-bold mb-2">Monthly Newsletter</h4>
                    ...
                    <div class="space-y-4 pt-8">
                        <div class="bg-brand-primary/10 border backdrop-blur rounded-2xl p-6 hover:bg-brand-primary/30 transition-all border-brand-primary" style="border-width: 2px;">
                            ...
                            <h4 class="text-brand-primary font-bold mb-2">Event Priority Access</h4>
                        ...
                        <div class="bg-brand-primary/10 border backdrop-blur rounded-2xl p-6 hover:bg-brand-primary/30 transition-all border-brand-primary" style="border-width: 2px;">
                            ...
                            <h4 class="text-brand-primary font-bold mb-2">Special Discounts</h4>
            ...
            <div class="w-full lg:w-1/2 animate-on-scroll delay-100">
                ...
                <ul class="space-y-4 mb-10">
                    ...
                    <li class="flex items-center gap-3 text-slate-500">
                        <div class="w-6 h-6 rounded-full bg-brand-accent/50 flex items-center justify-center shrink-0">
