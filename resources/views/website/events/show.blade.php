            ...
            <div class="flex flex-col items-center gap-6 lg:gap-8">
                ...
                @if($event->show_timer)
                    <div class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-lg p-6 md:p-10 inline-block shadow-2xl w-full">
                        <div class="text-[10px] md:text-sm font-black text-brand-accent uppercase tracking-widest mb-4 md:mb-8 lg:mb-12"><i class="fa-solid fa-fire text-orange-500 mr-1"></i> Nominations Closing Soon</div>
                        <div x-data="{
                            ...
                            <div><span class="flex-1 justify-center items-center text-3xl md:text-5xl lg:text-8xl font-black text-brand-accent" x-text="d">0</span><span class="text-[9px] md:text-sm lg:text-base font-black text-slate-500 uppercase tracking-widest">Days</span></div>
                            <div class="w-px h-10 bg-white/10 my-auto"></div>
                            <div><span class="flex-1 justify-center items-center text-3xl md:text-5xl lg:text-8xl font-black text-brand-accent" x-text="h">0</span><span class="text-[9px] md:text-sm lg:text-base font-black text-slate-500 uppercase tracking-widest">Hrs</span></div>
                            <div class="w-px h-10 bg-white/10 my-auto"></div>
                            <div><span class="flex-1 justify-center items-center text-3xl md:text-5xl lg:text-8xl font-black text-brand-accent" x-text="m">0</span><span class="text-[9px] md:text-sm lg:text-base font-black text-slate-500 uppercase tracking-widest">Min</span></div>
                            <div class="w-px h-10 bg-white/10 my-auto"></div>
                            <div><span class="flex-1 justify-center items-center text-3xl md:text-5xl lg:text-8xl font-black text-brand-accent" x-text="s">0</span><span class="text-[9px] md:text-sm lg:text-base font-black text-slate-500 uppercase tracking-widest">Sec</span></div>
                        </div>
                    </div>
                @endif
            </div>
