    ...
    <section class="relative min-h-[60vh] flex items-center pt-32 pb-24 overflow-hidden bg-slate-900">
        ...
        <div class="container relative z-10">
            <div class="flex flex-col items-center gap-6 lg:gap-8">
                ...
                @if($event->show_timer)
                <div class="text-[10px] md:text-base w-full text-left lg:text-lg font-black text-brand-light uppercase tracking-widest mb-4"><i class="fa-solid fa-fire text-orange-500 mr-1"></i> Event Starts in</div>
